...
def display_date_filter_sidebar(dataframe):
    ...
    with st.sidebar:
        for _ in range(10):
            st.write('')
        st.subheader('[Corentin PRADIE](https://www.linkedin.com/in/corentin-pradie/)')
        st.subheader('Github : [CorentinPRADIE](https://github.com/CorentinPRADIE)')
        st.subheader('#datavz2023efrei')
        st.subheader('Supervised by [MATHEW Mano Joseph](https://www.linkedin.com/in/manomathew/)')
